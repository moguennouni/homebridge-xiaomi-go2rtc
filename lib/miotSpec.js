...
const CONTROLS = [
  {
    id: 'standby', nameKey: 'settingStandby', service: 'camera-control', property: 'on',
    toHomeKit: (value) => value === false, toXiaomi: (on) => !on,
  },
  {
    id: 'indicator', nameKey: 'settingIndicator', service: 'indicator-light', property: 'on',
    toHomeKit: (value) => value === true, toXiaomi: (on) => on,
  },
  {
    id: 'tracking', nameKey: 'settingTracking', service: 'camera-control', property: 'motion-tracking',
    toHomeKit: (value) => value === true, toXiaomi: (on) => on,
  },
  {
    id: 'detection', nameKey: 'settingDetection', service: 'motion-detection', property: 'motion-detection',
    toHomeKit: (value) => value === true, toXiaomi: (on) => on,
  },
  {
    // Values: On (forced) / Off / Auto. The switch toggles between Auto and Off.
    id: 'night', nameKey: 'settingNight', service: 'camera-control', property: 'night-shot',
    prepare: (property) => {
